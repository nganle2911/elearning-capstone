...
export default function UserEnrollment({ data }) {
    ...
    const authCourse = (course, account) => {
        https.post("/api/QuanLyKhoaHoc/GhiDanhKhoaHoc", {"maKhoaHoc": course.maKhoaHoc, "taiKhoan": account}).then((res) => {
    ...
    const deleteEnrolledCourse = (course, account) => {
        https.post("/api/QuanLyKhoaHoc/HuyGhiDanh", {"maKhoaHoc": course.maKhoaHoc, "taiKhoan": account}).then((res) => {
        ...
        },
        {
            ...
            render: (_, record) => (
                <>
                    <Space size="large">
                        {/* Authentication */}
                        <Button onClick={() => { authCourse(record, data.taiKhoan) }}>
                        ...
                        {/* Delete */}
                        <Button onClick={() => { deleteEnrolledCourse(record, data.taiKhoan) }}>
                            <svg
