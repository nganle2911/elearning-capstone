        ...
        <div className='homePage__slider grid grid-cols-3'>
            ...
            <div className='slider__right col-span-1 lg:col-span-3 flex items-center lg:justify-center'>
                <div className='slider__content lg:text-center'>
                    <h1 className='text-6xl xl:text-4xl font-bold uppercase leading-tight xl:leading-tight' style={{color: "#1d7a85"}}>Khởi đầu <br /> sự nghiệp của bạn</h1>
                    <p className='text-3xl xl:text-xl leading-tight my-5' style={{ color: "#191919" }}>
                        Trở thành lập trình chuyên nghiệp 
                        <br /> 
                        tại 
                        <span className='font-bold uppercase'> E-Academy</span>
                    </p>
